...
interface Schema_public {
  likes: Table_public_likes;
  profiles: Table_public_profiles;
  tweets: Table_public_tweets;
}
interface Schema_realtime {
...
interface Tables_relationships {
  ...
  "public.likes": {
    parent: {
       public_likes_user_id_fkey: "public.profiles";
       public_likes_tweet_id_fkey: "public.tweets";
    };
    children: {
  ...
  "public.profiles": {
    parent: {
       public_profiles_id_fkey: "auth.users";
    };
    children: {
       public_likes_user_id_fkey: "public.likes";
       public_tweets_user_id_fkey: "public.tweets";
    };
  };
  "auth.refresh_tokens": {
    parent: {
  ...
  "public.tweets": {
    parent: {
       public_tweets_user_id_fkey: "public.profiles";
    };
    children: {
       public_likes_tweet_id_fkey: "public.likes";
    };
  };
  "auth.users": {
    parent: {
    ...
    children: {
       ...
       public_profiles_id_fkey: "public.profiles";
    };
  };
}
//#endregion
